            ...
            <div className="row">
                <div className="col-12">
                    <div className="skill-bx wow zoomIn">
                        <h2>Skills</h2>
                        <p>My passion for computer science is matched by my desire to constantly learn and grow in the field.<br></br>I have gained a strong foundation in various programming languages, including C, C++, Java and Python and am polishing my skills on DSA. <br/> I have also developed my skills in Web Development both Front End and Back End, which has allowed me to create dynamic, user-friendly and responsive websites.</p>
                        <Carousel responsive={responsive} infinite={true} autoPlay={true} mouseDrag={true} touchDrag={true} className="owl-carousel owl-theme skill-slider">
                            <div className="item">
