                    ...
                    <Container>
                        ...
                        onMouseLeave={() => setIsHovered(false)}>
                            ...
                            <ul>
                                ...
                                <li>CGPA: 9.19 (upto 3<sup>rd</sup> Sem)</li>
                            </ul>
                            </Col>
                        </Row>
                        <hr className={isHovered?"animate__animated animate__bounceInLeft visible" : "hide"}/>
                        ...
                        onMouseLeave={() => setIsHovered2(false)}>
                            ...
                            <ul>
                                ...
                                <li>Physics, Chemistry, Mathematics and Computer Science</li>
                                <li>April 2019 - May 2021*</li>
                                <li>Grade: 90.8%</li>
                            </ul>
                            </Col>
                        </Row>
                        <hr className={isHovered2?"animate__animated animate__bounceInLeft visible" : "hide"}/>
                        <Row className="education-list"  
                        ...
                        <hr className={isHovered3?"animate__animated animate__bounceInLeft visible" : "hide"}/>
                    </Container>
                    </div>
                </div>
            </div>
